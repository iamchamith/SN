...
namespace Alpha.Utility
{
    public class Email
    {
        public static void Send(EmailModel item)
        {
            ...
            try
            {
                var emailcontent = EmailContent.Replace("--Content", item.Body)
                    .Replace("--domain", GCInfo.Domain)
                    .Replace("--companyname", GCInfo.SiteName)
                    .Replace("--EmailType", item.Subject)
                    .Replace("--FirstName", item.UserName)
                    .Replace("--SiteLogo", GCInfo.SiteEmailLogo);
			...
			<tr>
				<td valign='top' mc:edit='headerBrand' id='templateContainerHeader'>
					...
					<p style='text-align:center;margin:0;padding:0;'>
						<img src='--SiteLogo' style='max-width:600px;display:inline-block;' />
					</p>
												...
												<table border='0' cellpadding='0' cellspacing='0' valign='top'>
													<tr>
														...
														<td align='left' valign='top' mc:edit='footer_sig' valign='top' style='margin:0;padding-top:10px;line-height:1;'>
															...
															<h5>Business Development at Criends</h5>
														</td>
													</tr>
												</table>
											</td>
					...
					<table width='100%' border='0' cellpadding='0' cellspacing='0' id='templateContainerFooter'>
						<tr>
							<td valign='top' width='100%' mc:edit='footer_unsubscribe'>
								<h6 style='text-align:center;margin-top: 7px;'><a href='--domain'>--companyname</a></h6>
							</td>
						</tr>
					</table>
				</td>
